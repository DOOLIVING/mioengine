...
function UI.drawUI()
    ...
    if sf >= 1 and sf <= #s.faces then
        ...
        love.graphics.print("+/- scale 6/7 width 8/9 height", px + 8, barH + 88)
        ...
        love.graphics.print("Tab - select vertex", px + 8, helpY)
        love.graphics.print("Arrows/QE - move vertex", px + 8, helpY + 16)
        love.graphics.print("1-5 - rotate face", px + 8, helpY + 32)
    else
        love.graphics.setColor(0.5, 0.5, 0.5)
