...
function love.load()
    ...
    state.setStatus("C=cube F=face Del=delete S=save I=texture +/-=scale 6/7=width 8/9=height 1-5=rotate Arrows=move")
end
...
function love.draw()
    ...
    love.graphics.print("lastKey: " .. state.lastKey, 8, state.H - 24)
end
